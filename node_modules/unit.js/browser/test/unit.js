...
this.sinon = function () {
    ...
    define.amd = {}, ("function" == typeof define && define.amd && function (e) {
        ...
        function l(e, t) {
            ...
            var n, r, i, o;
            for (n = 0, r = e.length; r > n; ++n)if (c(e[n], t[0])) {
                for (i = 0, o = t.length; o > i; ++i)if (!c(e[n + i], t[i]))return!1;
                return!0
            }
            return!1
        }

        var c, f = Object.prototype, h = "undefined" != typeof document && document.createElement("div");
        return c = function p(e, n) {
            ...
            if (n && "object" == typeof n) {
                var i;
                for (i in n)if (!p(e[i], n[i]))return!1;
                return!0
            }
            throw new Error("Matcher was not a string, a number, a function, a boolean or an object")
        }, {isArguments: n, isElement: r, isDate: o, isNegZero: s, identical: a, deepEqual: u, match: c, keys: i}
        ...
        function r(e, t) {
            ...
            var n, r;
            for (n = 0, r = t.length; r > n; ++n)if (t[n] === e)return!0;
            return!1
        }

        function i(t, n, o, s) {
            if ("string" == typeof n) {
                var u = t.quoteStrings, l = "boolean" != typeof u || u;
                return o || l ? '"' + n + '"' : n
            }
            ...
            var c, f;
            for (c = 0, f = a.length; f > c; c++)if (n === a[c].object)return a[c].value;
        ...
        var s = {excludeConstructors: ["Object", /^.$/], quoteStrings: !0}, a = (Object.prototype.hasOwnProperty, []);
        return"undefined" != typeof global && a.push({object: global, value: "[object global]"}), "undefined" != typeof document && a.push({object: document, value: "[object HTMLDocument]"}), "undefined" != typeof window && a.push({object: window, value: "[object Window]"}), i.func = function (e) {
            return"function " + t(e) + "() {}"
            ...
            var l = "<" + s + (u.length > 0 ? " " : ""), c = e.innerHTML;
            c.length > 20 && (c = c.substr(0, 20) + "[...]");
            var f = l + u.join(" ") + ">" + c + "</" + s + ">";
            return f.replace(/ contentEditable="inherit"/, "")
        }, o.prototype = {functionName: t, configure: function (e) {
            return new o(e)
    ...
    var sinon = function (e) {
        ...
        var u = "undefined" != typeof document && document.createElement("div"), l = Object.prototype.hasOwnProperty, c = {wrapMethod: function (e, t, n) {
            ...
            var i, s = e[t];
            if (r(s)) {
                if (s.restore && s.restore.sinon)i = new TypeError("Attempted to wrap " + t + " which is already wrapped"); else if (s.calledBefore) {
            ...
            for (var t = 1, n = arguments.length; n > t; t += 1)for (var r in arguments[t])arguments[t].hasOwnProperty(r) && (e[r] = arguments[t][r]), arguments[t].hasOwnProperty("toString") && arguments[t].toString != e.toString && (e.toString = arguments[t].toString);
            return e
        }, create                                                                                                                    : function (e) {
            var t = function () {
            };
            ...
            return"" + e
        }, defaultConfig                                                                                                             : {injectIntoThis: !0, injectInto: null, properties: ["spy", "stub", "mock", "clock", "server", "requests"], useFakeTimers: !0, useFakeServer: !0}, timesInWords: function (e) {
            return 1 == e && "once" || 2 == e && "twice" || 3 == e && "thrice" || (e || 0) + " times"
        }, calledInOrder                                                                                                             : function (e) {
            for (var t = 1, n = e.length; n > t; t++)if (!e[t - 1].calledBefore(e[t]) || !e[t].called)return!1;
            return!0
        }, orderByFirstCall                                                                                                          : function (e) {
            return e.sort(function (e, t) {
                var n = e.getCall(0), r = t.getCall(0), i = n && n.callId || -1, o = r && r.callId || -1;
                return o > i ? -1 : 1
            })
        }, log                                                                                                                       : function () {
        ...
        }}, f = "undefined" != typeof module && module.exports && "function" == typeof require, h = "function" == typeof define && "object" == typeof define.amd && define.amd;
        if (h)define(a); else if (f) {
            try {
                e = require("formatio")
            } catch (p) {
            }
        ...
        if (e) {
            var d = e.configure({quoteStrings: !1});
            c.format = function () {
    ...
    if (function (e) {
        ...
        function i(n, r) {
            return function (i, o) {
                t(i, "string", "property");
                var s = 1 === arguments.length, u = r + '("' + i + '"';
        ...
        if (!e && r && (e = require("../sinon")), e) {
            var i = Array.prototype.slice, o = {calledOn: function (t) {
                return e.match && e.match.isMatcher(t) ? t.test(this.thisValue) : this.thisValue === t
            }, calledWith                               : function () {
                for (var t = 0, n = arguments.length; n > t; t += 1)if (!e.deepEqual(arguments[t], this.args[t]))return!1;
                return!0
            }, calledWithMatch                          : function () {
                for (var t = 0, n = arguments.length; n > t; t += 1) {
                    var r = this.args[t], i = arguments[t];
                ...
                for (var n = this.args, r = 0, o = n.length; o > r; ++r)if ("function" == typeof n[r])return void n[r].apply(e, i.call(arguments, 1));
                ...
                for (var r = this.args, o = 0, s = r.length; s > o; ++o)if (r[o] && "function" == typeof r[o][e])return void r[o][e].apply(n, i.call(arguments, 2));
        ...
        function matchingFake(e, t, n) {
            if (e)for (var r = 0, i = e.length; i > r; r++)if (e[r].matches(t, n))return e[r]
        }
        ...
        function delegateToCalls(e, t, n, r) {
            spyApi[e] = function () {
                ...
                for (var i, o = 0, s = 0, a = this.callCount; a > s; s += 1)if (i = this.getCall(s), i[n || e].apply(i, arguments) && (o += 1, t))return!0;
                return o === this.callCount
            }
        }

        var commonJSModule = "undefined" != typeof module && module.exports && "function" == typeof require, push = Array.prototype.push, slice = Array.prototype.slice, callId = 0;
        if (!sinon && commonJSModule && (sinon = require("../sinon")), sinon) {
            var vars = "a,b,c,d,e,f,g,h,i,j,k,l", uuid = 0, spyApi = {reset: function () {
                if (this.called = !1, this.notCalled = !0, this.calledOnce = !1, this.calledTwice = !1, this.calledThrice = !1, this.callCount = 0, this.firstCall = null, this.secondCall = null, this.thirdCall = null, this.lastCall = null, this.args = [], this.returnValues = [], this.thisValues = [], this.exceptions = [], this.callIds = [], this.fakes)for (var e = 0; e < this.fakes.length; e++)this.fakes[e].reset()
            }, create                                                      : function (e) {
                var t;
                "function" != typeof e ? e = function () {
                } : t = sinon.functionName(e);
                var n = createProxy(e);
            ...
            delegateToCalls("calledOn", !0), delegateToCalls("alwaysCalledOn", !1, "calledOn"), delegateToCalls("calledWith", !0), delegateToCalls("calledWithMatch", !0), delegateToCalls("alwaysCalledWith", !1, "calledWith"), delegateToCalls("alwaysCalledWithMatch", !1, "calledWithMatch"), delegateToCalls("calledWithExactly", !0), delegateToCalls("alwaysCalledWithExactly", !1, "calledWithExactly"), delegateToCalls("neverCalledWith", !1, "notCalledWith", function () {
                ...
                throw new Error(this.toString() + " cannot yield to '" + e + "' since it was not yet invoked.")
            }), spyApi.formatters = {c: function (e) {
        ...
        var o = "undefined" != typeof module && module.exports && "function" == typeof require;
        if (!e && o && (e = require("../sinon")), e) {
            var s, a = Array.prototype.slice, u = Array.prototype.join, l = function () {
            ...
            }, "throws"      : t, throwsException: t, returns: function (e) {
        ...
        if (!e && o && (e = require("../sinon")), e) {
            ...
            e.extend(t, function () {
                var n = {create : function () {
                    ...
                    var e;
                    if (this.defaultBehavior = null, this.behaviors = [], delete this.returnValue, delete this.returnArgAt, this.returnThis = !1, this.fakes)for (e = 0; e < this.fakes.length; e++)this.fakes[e].resetBehavior()
                }, onCall       : function (t) {
        ...
        var n, r = "undefined" != typeof module && module.exports && "function" == typeof require, i = [].push;
        if (!e && r && (e = require("../sinon")), e) {
            n = e.match, !n && r && (n = require("./match")), e.mock = t, e.extend(t, function () {
                function n(e, t) {
                    if (e)for (var n = 0, r = e.length; r > n; n += 1)t(e[n])
                }
                ...
                return{create  : function (n) {
                    ...
                    var o, s = this.expectations && this.expectations[t], a = s && s.length || 0;
                    for (o = 0; a > o; o += 1)if (!s[o].met() && s[o].allowsCall(n, r))return s[o].apply(n, r);
                    var u, l = [], c = 0;
                    for (o = 0; a > o; o += 1)s[o].allowsCall(n, r) ? u = u || s[o] : c += 1, i.call(l, "    " + s[o].toString());
                    return 0 === c ? u.apply(n, r) : (l.unshift("Unexpected call: " + e.spyCall.toString.call({proxy: t, args: r})), void e.expectation.fail(l.join("\n")))
                }}
            }());
            ...
            e.expectation = function () {
                ...
                var l = Array.prototype.slice, c = e.spy.invoke;
                return{minCalls     : 1, maxCalls: 1, create: function (t) {
                    ...
                    var o = e.spyCall.toString.call({proxy: this.method || "anonymous mock expectation", args: n}), s = o.replace(", [...", "[, ...") + " " + r(this);
        ...
        var i = "undefined" != typeof module && module.exports && "function" == typeof require, o = [].push, s = Object.prototype.hasOwnProperty;
        if (!e && i && (e = require("../sinon")), e) {
            var a = {verify    : function () {
                n(this, "verify")
            }, restore         : function () {
                ...
                if (n) {
                    ...
                    if ("function" != typeof i) {
                        ...
                        return t[n] = r, this.add({restore: function () {
                            t[n] = i
                        }})
                    }
                }
    ...
    if (function (global) {
        function addTimer(e, t) {
            ...
            var n = id++, r = e[1] || 0;
            return this.timeouts || (this.timeouts = {}), this.timeouts[n] = {id: n, func: e[0], callAt: this.now + r, invokeArgs: Array.prototype.slice.call(e, 2)}, t === !0 && (this.timeouts[n].interval = r), addTimerReturnsObject ? {id: n, ref: function () {
            }, unref                                                                                                                                                                                                                          : function () {
            }} : n
        }
        ...
        function createObject(e) {
            var t;
            if (Object.create)t = Object.create(e); else {
                var n = function () {
                };
        ...
        function restore() {
            for (var e, t = 0, n = this.methods.length; n > t; t++)if (e = this.methods[t], global[e].hadOwnProperty)global[e] = this["_" + e]; else try {
                delete global[e]
            } catch (r) {
            }
            this.methods = []
        ...
        }, 0), addTimerReturnsObject = "object" == typeof timeoutResult;
        clearTimeout(timeoutResult);
        var id = 1;
        sinon.clock = {now  : 0, create: function (e) {
            ...
            var n, r, i = null;
            for (var o in this.timeouts)if (this.timeouts.hasOwnProperty(o)) {
                if (this.timeouts[o].callAt < e || this.timeouts[o].callAt > t)continue;
                (null === i || this.timeouts[o].callAt < i) && (r = this.timeouts[o], i = this.timeouts[o].callAt, n = {func: this.timeouts[o].func, callAt: this.timeouts[o].callAt, interval: this.timeouts[o].interval, id: this.timeouts[o].id, invokeArgs: this.timeouts[o].invokeArgs})
            }
            return n || null
        ...
        }, sinon.Event.prototype = {initEvent: function (e, t, n, r) {
        ...
        }, sinon.CustomEvent.prototype = new sinon.Event, sinon.CustomEvent.prototype.constructor = sinon.CustomEvent, sinon.EventTarget = {addEventListener: function (t, n) {
            this.eventListeners = this.eventListeners || {}, this.eventListeners[t] = this.eventListeners[t] || [], e.call(this.eventListeners[t], n)
        }, removeEventListener                                                                                                                              : function (e, t) {
            for (var n = this.eventListeners && this.eventListeners[e] || [], r = 0, i = n.length; i > r; ++r)if (n[r] == t)return n.splice(r, 1)
        ...
        function n() {
            this.eventListeners = {progress: [], load: [], abort: [], error: []}
        }
        ...
        function o(e, t) {
            for (var n = 0; n < e.length; n++)if (t(e[n]) === !0)return!0;
            return!1
        }
        ...
        var c = "undefined" != typeof ProgressEvent, f = "undefined" != typeof CustomEvent;
        sinon.xhr = {XMLHttpRequest: e.XMLHttpRequest};
        var h = sinon.xhr;
        ...
        var p = {"Accept-Charset": !0, "Accept-Encoding": !0, Connection: !0, "Content-Length": !0, Cookie: !0, Cookie2: !0, "Content-Transfer-Encoding": !0, Date: !0, Expect: !0, Host: !0, "Keep-Alive": !0, Referer: !0, TE: !0, Trailer: !0, "Transfer-Encoding": !0, Upgrade: !0, "User-Agent": !0, Via: !0};
        n.prototype.addEventListener = function (e, t) {
            this.eventListeners[e].push(t)
        }, n.prototype.removeEventListener = function (e, t) {
            for (var n = this.eventListeners[e] || [], r = 0, i = n.length; i > r; ++r)if (n[r] == t)return n.splice(r, 1)
        ...
        t.defake = function (e, n) {
            ...
            var o = function (t) {
                ...
                e.readyState = r.readyState, r.readyState >= t.HEADERS_RECEIVED && o(["status", "statusText"]), r.readyState >= t.LOADING && o(["responseText"]), r.readyState === t.DONE && o(["responseXML"]), e.onreadystatechange && e.onreadystatechange.call(e, {target: e})
            };
            ...
            d(r, "open", n)
        }, t.useFilters = !1, sinon.extend(t.prototype, sinon.EventTarget, {async: !0, open: function (e, n, r, i, s) {
            if (this.method = e, this.url = n, this.async = "boolean" == typeof r ? r : !0, this.username = i, this.password = s, this.responseText = null, this.responseXML = null, this.requestHeaders = {}, this.sendFlag = !1, sinon.FakeXMLHttpRequest.useFilters === !0) {
                var a = arguments, u = o(t.filters, function (e) {
            ...
            switch (this.dispatchEvent(new sinon.Event("readystatechange")), this.readyState) {
                case t.DONE:
                    this.dispatchEvent(new sinon.Event("load", !1, !1, this)), this.dispatchEvent(new sinon.Event("loadend", !1, !1, this)), this.upload.dispatchEvent(new sinon.Event("load", !1, !1, this)), c && this.upload.dispatchEvent(new sinon.ProgressEvent("progress", {loaded: 100, total: 100}))
            }
            ...
            e = e.toLowerCase();
            for (var n in this.responseHeaders)if (n.toLowerCase() == e)return this.responseHeaders[n];
            return null
            ...
            f && this.upload.dispatchEvent(new sinon.CustomEvent("error", {detail: e}))
        }}), sinon.extend(t, {UNSENT: 0, OPENED: 1, HEADERS_RECEIVED: 2, LOADING: 3, DONE: 4}), t.parseXML = function (e) {
            var t;
    ...
    if (sinon.fakeServer = function () {
        ...
        function i(e, t) {
            ...
            if ((!/^https?:\/\//.test(n) || a.test(n)) && (n = n.replace(a, "")), r(e, this.getHTTPMethod(t), n)) {
                if ("function" == typeof e.response) {
                    var i = e.url, o = [t].concat(i && "function" == typeof i.exec ? i.exec(n).slice(1) : []);
        ...
        var o = [].push, s = "undefined" != typeof window ? window.location : {}, a = new RegExp("^" + s.protocol + "//" + s.host);
        return{create    : function () {
            ...
            return 1 == arguments.length && "function" != typeof e ? void(this.response = n(e)) : (this.responses || (this.responses = []), 1 == arguments.length && (r = e, t = e = null), 2 == arguments.length && (r = t, t = e, e = null), void o.call(this.responses, {method: e, url: t, response: "function" == typeof r ? r : n(r)}))
        }, respond       : function () {
            ...
            try {
                ...
                if (this.responses)for (var n = this.responses.length, r = n - 1; r >= 0; r--)if (i.call(this, this.responses[r], e)) {
        ...
        e.prototype = sinon.fakeServer, sinon.fakeServerWithClock = new e, sinon.fakeServerWithClock.addRequest = function (e) {
            if (e.async && ("object" == typeof setTimeout.clock ? this.clock = setTimeout.clock : (this.clock = sinon.useFakeTimers(), this.resetClock = !0), !this.longestTimeout)) {
                var t = this.clock.setTimeout, n = this.clock.setInterval, r = this;
    ...
    return function () {
        ...
        var n = [].push;
        sinon.sandbox = sinon.extend(sinon.create(sinon.collection), {useFakeTimers: function () {
            return this.clock = sinon.useFakeTimers.apply(sinon, arguments), this.add(this.clock)
        }, serverPrototype                                                         : sinon.fakeServer, useFakeServer: function () {
            ...
            var i, o, s = r.inject({});
            if (n.properties)for (var a = 0, u = n.properties.length; u > a; a++)i = n.properties[a], o = s[i] || "sandbox" == i && r, e(r, n, i, o); else e(r, n, "sandbox", o);
            return r
        ...
        function t(t) {
            function n() {
                ...
                var r, i, o = e.sandbox.create(n), s = Array.prototype.slice.call(arguments).concat(o.args);
                try {
                    i = t.apply(this, s)
                } catch (a) {
                    r = a
        ...
        !e && n && (e = require("../sinon")), e && (t.config = {injectIntoThis: !0, injectInto: null, properties: ["spy", "stub", "mock", "clock", "server", "requests"], useFakeTimers: !0, useFakeServer: !0}, e.test = t, "function" == typeof define && define.amd ? define(["module"], function (e) {
            e.exports = t
        }) : n && (module.exports = t))
    }("object" == typeof sinon && sinon || null), function (e) {
        function t(e, t, n) {
        ...
        function n(n, r) {
            ...
            r = r || "test";
            var i, o, s, a = new RegExp("^" + r), u = {}, l = n.setUp, c = n.tearDown;
    ...
    }("object" == typeof sinon && sinon || null), function (e, t) {
        function n() {
        ...
        var s, a = "undefined" != typeof module && module.exports && "function" == typeof require, u = Array.prototype.slice;
        !e && a && (e = require("../sinon")), e && (s = {failException: "AssertError", fail: function (e) {
            var t = new Error(e);
            ...
            var t = "", i = "";
            if (e.calledInOrder(arguments))s.pass("callOrder"); else {
                try {
            ...
            var n = t || {}, r = "undefined" == typeof n.prefix && "assert" || n.prefix, i = "undefined" == typeof n.includeFail || !!n.includeFail;
            for (var s in this)"export" == s || !i && /^(fail)/.test(s) || (e[o(r, s)] = this[s]);
            return e
        }, match                                                      : function (t, n) {
            var i = e.match(n);
            if (i.test(t))s.pass("match"); else {
    ...
    }("object" == typeof sinon && sinon || null, "undefined" != typeof window ? window : "undefined" != typeof self ? self : global), "undefined" == typeof sinon && (this.sinon = {}), sinon.xdr = {XDomainRequest: this.XDomainRequest}, function (e) {
        function t() {
        ...
        var o = sinon.xdr;
        o.GlobalXDomainRequest = e.XDomainRequest, o.supportsXDR = "undefined" != typeof o.GlobalXDomainRequest, o.workingXDR = o.supportsXDR ? o.GlobalXDomainRequest : !1, sinon.extend(t.prototype, sinon.EventTarget, {open: function (e, n) {
        ...
        }}), sinon.extend(t, {UNSENT: 0, OPENED: 1, LOADING: 3, DONE: 4}), sinon.useFakeXDomainRequest = function () {
...
!function (t) {
    ...
    "use strict";
    r(3);
    var n = r(4), i = r(5), o = r(6), s = r(7), a = r(8), u = r(23), c = r(22), l = r(2);
    ...
    var f = i.bind(n), h = new f;
    n = s.merge(n, h), Object.defineProperty(n, "should", {value: u}), Object.defineProperty(n, "must", {value: c}), t.exports = n
}, function (t) {
    t.exports = sinon
}, function (t, e, r) {
    "use strict";
    ...
    var i = r(27).Noder;
    n.prototype = Object.create(i.prototype, {constructor: {value: n}}), n.prototype.UnitJS = n, t.exports = new n
}, function (t, e, r) {
    "use strict";
    var n = r(3), i = r(21);
    t.exports = function () {
    ...
    function s(t, e, r, n, i) {
        throw new g.AssertionError({message: r, actual: t, expected: e, operator: n, stackStartFunction: i})
    }
    ...
    function l(t, e) {
        ...
        for (i.sort(), o.sort(), n = i.length - 1; n >= 0; n--)if (i[n] != o[n])return!1;
        for (n = i.length - 1; n >= 0; n--)if (r = i[n], !u(t[r], e[r]))return!1;
        return!0
    }
    ...
    var p = r(43), d = Array.prototype.slice, y = Object.prototype.hasOwnProperty, g = t.exports = a;
    ...
    "use strict";
    var n = r(47), i = r(5), o = r(24), s = r(25), a = s.concat(["matchEach", "notMatchEach", "isEmpty", "isNotEmpty", "hasLength", "hasNotLength", "hasValue", "notHasValue", "hasValues", "notHasValues", "contains", "notContains", "isReverseOf", "isNotReverseOf", "isEnumerable", "isNotEnumerable", "hasKey", "notHasKey", "hasProperty", "hasNotProperty"]);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
    ...
    "use strict";
    var n = r(47), i = r(5), o = r(24);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
        for (var a in s)this[a] = s[a];
        e.isBool(this.actual);
        var u = ["isTrue", "isNotTrue", "isFalse", "isNotFalse"], c = n.pick(e, u);
        for (var a in c)this[a] = c[a];
        return this
    }
}, function (t, e, r) {
    "use strict";
    var n = r(47), i = r(5), o = r(24), s = r(25), a = s.concat(["isBetween", "isNotBetween", "isBefore", "isAfter"]);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
        for (var u in s)this[u] = s[u];
    ...
    var n = r(13);
    t.exports = function (t) {
        var e = n.bind(this), r = new e(t), i = r.isError();
    ...
    var i, o, s = r(47), a = r(5), u = r(24), c = r(25), l = r(7), f = r(4), h = c.concat(["isType", "isNotType", "isObject", "isArray", "isString", "isNumber", "isBool", "isBoolean", "isNull", "isUndefined", "isRegExp", "isNotRegExp", "isDate", "isNotDate", "isArguments", "isNotArguments", "isEmpty", "isNotEmpty", "hasLength", "hasNotLength", "isInstanceOf", "isNotInstanceOf", "isEnumerable", "isNotEnumerable", "isFrozen", "isNotFrozen", "hasProperty", "hasNotProperty", "hasOwnProperty", "hasNotOwnProperty", "hasProperties", "hasNotProperties", "hasOwnProperties", "hasKey", "notHasKey", "hasKeys", "notHasKeys", "hasValue", "notHasValue", "hasValues", "notHasValues", "contains", "notContains", "startsWith", "notStartsWith", "endsWith", "notEndsWith"]), p = {isError: function () {
        return this.isInstanceOf(Error)
    }, match                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           : function (t) {
        var e = "function" == typeof t && t(i, o) !== !0, r = "function" != typeof t && !n(t);
        if (e || r)throw new Error("exception has not the expected value (" + t + ")");
        return this
    }, notMatch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        : function (t) {
        var e = "function" == typeof t && t(i, o), r = "function" != typeof t && n(t);
    ...
    t.exports = function (t) {
        ...
        var n = u.call(this, i), c = a.bind(this), d = new c;
    ...
    var i, o = r(47), s = r(5), a = r(24), u = r(25), c = r(7), l = u.concat(["throws", "isError"]), f = {hasName: function (t) {
        return this.value(n()).isIdenticalTo(t), this
    }};
    t.exports = function (t) {
        this.actual = i = t;
        var e = a.call(this, t), r = s.bind(this), n = new r;
    ...
    "use strict";
    var n = r(47), i = r(5), o = r(24), s = r(25), a = s.concat(["matchEach", "notMatchEach", "isBetween", "isNotBetween", "isBefore", "isAfter", "isGreaterThan", "isLessThan", "isApprox", "isInfinite", "isNotInfinite"]);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
        for (var u in s)this[u] = s[u];
    ...
    var i = r(47), o = r(5), s = r(24), a = r(25), u = r(7), c = a.concat(["matchEach", "notMatchEach", "isArray", "isRegExp", "isNotRegExp", "isDate", "isNotDate", "isArguments", "isNotArguments", "isEmpty", "isNotEmpty", "hasLength", "hasNotLength", "isInstanceOf", "isNotInstanceOf", "isEnumerable", "isNotEnumerable", "isFrozen", "isNotFrozen", "hasProperty", "hasNotProperty", "hasOwnProperty", "hasNotOwnProperty", "hasProperties", "hasNotProperties", "hasOwnProperties", "hasKey", "notHasKey", "hasKeys", "notHasKeys", "hasValue", "notHasValue", "hasValues", "notHasValues", "contains", "notContains"]), l = {hasName: function (t) {
        return this.value(n(this.actual)).isIdenticalTo(t), this
    }};
    t.exports = function (t) {
        this.actual = t;
        var e = s.call(this, t), r = o.bind(this), n = new r;
    ...
    "use strict";
    var n = r(47), i = r(5), o = r(24), s = r(25), a = s.concat(["isEnumerable", "isNotEnumerable", "isFrozen", "isNotFrozen", "hasProperty", "hasNotProperty", "hasOwnProperty", "hasNotOwnProperty", "hasKey", "notHasKey"]);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
        for (var u in s)this[u] = s[u];
    ...
    "use strict";
    var n = r(47), i = r(5), o = r(24), s = r(25), a = s.concat(["matchEach", "notMatchEach", "isEmpty", "isNotEmpty", "hasLength", "hasNotLength", "startsWith", "notStartsWith", "endsWith", "notEndsWith", "hasValue", "notHasValue", "hasValues", "notHasValues", "contains", "notContains"]);
    t.exports = function (t) {
        this.actual = t;
        var e = o.call(this, t), r = i.bind(this), s = new r;
        for (var u in s)this[u] = s[u];
    ...
    t.exports = function (t) {
        this.actual = t;
        var e = i.call(this, t), r = n.bind(this), o = new r;
    ...
    "use strict";
    var n = r(7), i = r(26), o = r(4);
    t.exports = {"case": function () {
        if (arguments.length)for (var t in arguments)"function" == typeof arguments[t] && arguments[t].call(o.$di._container);
        return o
    }, given           : function () {
        ...
        var t = "======================", e = "______________________", r = "                             ", n = 0;
        ...
        var e = Array.prototype.slice.call(arguments), r = {actual: e.length >= 3 ? e[2] : this.actual};
        e.length >= 2 && (r.expected = e[1]), e.length >= 4 && (r.inspect = e.slice(3)), i(t, r)
    }, stats           : {assertions: {}, total: {assertions: 0}}}
}, function (t, e, r) {
    function n(t) {
    ...
    var o = r(28), s = r(29);
    t.exports = n, n.prototype = Object.create(o, {constructor: {value: n, writable: !0, configurable: !0}}), n.AssertionError = s, Object.defineProperty(Object.prototype, "must", {get: function () {
        return new n(i(this))
    }, set                                                                                                                                                                              : function (t) {
        Object.defineProperty(this, "must", {value: t, configurable: !0, enumrable: !0, writable: !0})
    }, configurable                                                                                                                                                                     : !0})
}, function (t, e, r) {/*!
 * Should
 ...
 * MIT Licensed
 */
    var n = r(31), i = n.AssertionError, o = n.inspect, s = function (t) {
    ...
    a.add = function (t, e, r) {
        ...
        return n.isDate(t) && "function" != typeof t.inspect ? t.toISOString() : o(t, {depth: null})
    }, s.use = function (t) {
        return t(this, a), this
    }, e = t.exports = s, Object.defineProperty(Object.prototype, "should", {set: function () {
    }, get                                                                      : function () {
        return s(this)
    }, configurable                                                             : !0}), a.prototype = {constructor: a, assert: function (t) {
        if (t)return this;
        var e = this.params, r = e.message, n = !1;
        r || (r = this.getMessage(), n = !0);
        var o = new i({message: r, actual: this.obj, expected: e.expected, stackStartFunction: this.assert});
    ...
    var i = r(8), o = r(23), s = r(22), a = r(21).stats, u = r(21).fail;
    t.exports = function (t) {
        return{is            : function (e) {
            ...
            if (n("matchEach", !0), "function" == typeof e) {
                if ("object" == typeof t)for (var r in t)e(t[r], r) !== !0 && u("matchEach()", t[r], e); else e(t) !== !0 && u("matchEach()", t, e);
                return this
            }
            for (var i in e)if ("function" != typeof e[i])this.match(e[i]); else {
                if ("object" == typeof t) {
            ...
            if (n("notMatchEach", !0), "function" == typeof e) {
                if ("object" == typeof t)for (var r in t)e(t[r], r) && u("notMatchEach()", t[r], e); else e(t) && u("notMatchEach()", t, e);
                return this
            }
            for (var i in e)if ("function" != typeof e[i])this.notMatch(e[i]); else {
                if ("object" == typeof t) {
            ...
            if (1 == arguments.length)s(t).property(e); else {
            ...
            if (1 === arguments.length)s(t).not.property(e); else {
            ...
            if (1 === arguments.length)s(t).ownProperty(e); else {
            ...
            if (1 === arguments.length)s(t).not.ownProperty(e); else {
            ...
            if (n("contains", !0), arguments.length > 1)for (var r in arguments)o(t).containDeep(arguments[r]); else o(t).containDeep(e);
            return this
        }, notContains       : function (e) {
            if (n("notContains", !0), arguments.length > 1)for (var r in arguments)o(t).not.containDeep(arguments[r]); else o(t).not.containDeep(e);
            return this
    ...
    "use strict";
    function n() {
        this.$di = new n.prototype.$di, this.$di.addAll({$api: this, $di: this.$di, $container: this.$di._container, $invoke: this.$wrap(this.$invoke), $inject: this.$wrap(this.$inject), $provider: this.$wrap(this.$provider), $factory: this.$wrap(this.$factory), $singleton: this.$wrap(this.$singleton), $apply: this.$wrap(this.$apply), $wrap: this.$wrap(this.$wrap)})
    }
    ...
    n.prototype.Noder = n, n.prototype.$di = i, n.prototype.Collection = i, n.prototype.createCollection = function (t) {
        ...
        return Object.defineProperty(this, t, {enumerable: !0, configurable: !1, get: function () {
    ...
    function i(t, e, r, n) {
        if (t === e)return!0;
        var u = o(t) ? "plain" : y(t), c = o(e) ? "plain" : y(e);
        if (u != c)return!1;
        if ("object" == u || "plain" == u || "array" == u) {
            var l = r && r.indexOf(t), f = n && n.indexOf(e);
            if (l != f)return!1;
        ...
        switch (u) {
            ...
            case"array":
                if (t.length != e.length)return!1;
                if (0 == t.length)return!0;
                for (var h = 0, d = t.length; d > h; ++h)if (!i(t[h], e[h], r, n))return!1;
                return!0;
            case"object":
                if (s(t) !== s(e))return!1;
            ...
            case"plain":
                ...
                for (var m in t)if (!i(t[m], e[m], r, n))return!1;
                return!0
        }
        return!1
    }
    ...
    function c(t, e) {
        ...
        var r = "string" == y(t) ? t : t.message, n = y(e);
    ...
    function f(t, e, r, n) {
        if (this.negative ? t : !t) {
            var i = this.negative ? "not " : "", o = g(this.actual) + " must " + i;
    ...
    e = t.exports = {get a() {
        ...
        f.call(this, e, "be equivalent to", t, {diffable: !0})
    }, e.include = function (t) {
        var e;
        if (Array.isArray(this.actual) || "string" == y(this.actual))e = ~this.actual.indexOf(t); else for (var r in this.actual)if (this.actual[r] === t) {
            e = !0;
            break
        }
        ...
        f.call(this, e, "be a permutation of", t, {diffable: !0})
    }, e.match = function (t) {
        ...
        var e = null != this.actual, r = e && p(Object(this.actual));
        e = e && i(r.sort(), t.sort()), f.call(this, e, "have keys", t)
    }, e.ownKeys = function (t) {
        var e = null != this.actual, r = e && Object.keys(Object(this.actual));
    ...
    t.exports = e, e.prototype = Object.create(Error.prototype, {constructor: {value: e, configurable: !0, writable: !0}}), e.prototype.name = "AssertionError", e.prototype.__defineGetter__("showDiff", function () {
 ...
 * MIT Licensed
 */
    var n = r(31), i = r(8), o = i.AssertionError;
    t.exports = function (t) {
        var e = t.format;
        n.merge(t, i), t.exist = t.exists = function (r, n) {
            if (null == r)throw new o({message: n || "expected " + e(r) + " to exist", stackStartFunction: t.exist})
        }, t.not = {}, t.not.exist = t.not.exists = function (r, n) {
            if (null != r)throw new o({message: n || "expected " + e(r) + " to not exist", stackStartFunction: t.not.exist})
        }
    }
}, function (t) {/*!
 * Should
 ...
 */
    t.exports = function (t, e) {
        function r(t) {
            Object.defineProperty(e.prototype, t, {get: function () {
                return this
            }, enumerable                             : !0})
        }
 ...
 */
    ...
    t.exports = function (t, e) {
        e.add("eql", function (t, e) {
            this.params = {operator: "to equal", expected: t, showDiff: !0, message: e}, this.assert(n(t, this.obj))
        }), e.add("equal", function (t, e) {
            this.params = {operator: "to be", expected: t, showDiff: !0, message: e}, this.assert(t === this.obj)
 ...
 */
    ...
    t.exports = function (t, e) {
        e.add("Number", function () {
            this.params = {operator: "to be a number"}, this.assert(n.isNumber(this.obj))
        }, !0), e.add("arguments", function () {
            this.params = {operator: "to be arguments"}, this.assert(n.isArguments(this.obj))
        }, !0), e.add("type", function (t, e) {
            this.params = {operator: "to have type " + t, message: e}, (typeof this.obj).should.be.exactly(t, e)
        }), e.add("instanceof", function (t, e) {
            this.params = {operator: "to be an instance of " + n.functionName(t), message: e}, this.assert(Object(this.obj)instanceof t)
        }), e.add("Function", function () {
            this.params = {operator: "to be a function"}, this.assert(n.isFunction(this.obj))
        }, !0), e.add("Object", function () {
            this.params = {operator: "to be an object"}, this.assert(n.isObject(this.obj))
        }, !0), e.add("String", function () {
            this.params = {operator: "to be a string"}, this.assert(n.isString(this.obj))
        }, !0), e.add("Array", function () {
            this.params = {operator: "to be an array"}, this.assert(n.isArray(this.obj))
        }, !0), e.add("Boolean", function () {
            this.params = {operator: "to be a boolean"}, this.assert(n.isBoolean(this.obj))
        }, !0), e.add("Error", function () {
            this.params = {operator: "to be an error"}, this.assert(n.isError(this.obj))
 ...
 * MIT Licensed
 */
    var n = r(31), i = r(52), o = Array.prototype.slice;
    t.exports = function (t, e) {
        var r = t.format;
        e.add("enumerable", function (t, e) {
            t = String(t), this.params = {operator: "to have enumerable property " + n.formatProp(t)}, this.assert(this.obj.propertyIsEnumerable(t)), arguments.length > 1 && (this.params.operator += " equal to " + r(e), this.assert(i(e, this.obj[t])))
            ...
            this.params = {operator: c}, this.assert(0 === a.length || this.anyOne && a.length != t.length);
            var l = Object.keys(e);
            if (l.length) {
                var f = [];
                ...
                }), (0 !== f.length && !this.anyOne || this.anyOne && 0 === u.length) && (u = f), c = (1 === u.length ? "to have property " : "to have " + (this.anyOne ? "any of " : "") + "properties ") + u.join(", "), this.params = {operator: c}, this.assert(0 === f.length || this.anyOne && f.length != l.length)
            }
        ...
        e.add("ownProperty", function (t, e) {
            t = String(t), this.params = {operator: "to have own property " + n.formatProp(t), message: e}, this.assert(s.call(this.obj, t)), this.obj = this.obj[t]
        }), e.alias("ownProperty", "hasOwnProperty"), e.add("empty", function () {
            if (this.params = {operator: "to be empty"}, n.isString(this.obj) || n.isArray(this.obj) || n.isArguments(this.obj))this.have.property("length", 0); else {
            ...
            e = e.map(String);
            for (var i, s = t(Object(this.obj)), a = []; i = e.shift();)this.params = {operator: "to have property by path " + r.join(", ") + " - failed on " + n.formatProp(i)}, s = s.have.property(i), a.push(i);
            this.params = {operator: "to have property by path " + r.join(", ")}, this.obj = s.obj
        })
    }
}, function (t, e, r) {/*!
 * Should
 ...
 */
    ...
    t.exports = function (t, e) {
        ...
        e.add("throw", function (e, i) {
            ...
            if (u)if (e) {
                if ("string" == typeof e)c = e == s.message; else if (e instanceof RegExp)c = e.test(s.message); else if ("function" == typeof e)c = s instanceof e; else if (n.isObject(e))try {
                    s.should.match(e)
                } catch (l) {
            ...
            this.params = {operator: "to throw exception" + a}, this.assert(u), this.assert(c)
 ...
 */
    ...
    t.exports = function (t, e) {
        ...
        e.add("match", function (o, s) {
            if (this.params = {operator: "to match " + r(o), message: s}, !i(this.obj, o))if (n.isRegExp(o)) {
                if (n.isString(this.obj))this.assert(o.exec(this.obj)); else if (n.isArray(this.obj))this.obj.forEach(function (t) {
                    this.assert(o.exec(t))
                }, this); else if (n.isObject(this.obj)) {
                    var a = [], u = [];
            ...
            this.params = {operator: "to match each " + r(t), message: e};
            var o = t;
 ...
 */
    ...
    t.exports = function (t, e) {
        ...
        e.add("containEql", function (t) {
            this.params = {operator: "to contain " + r(t)};
            var e = this.obj;
            ...
            this.params = {operator: "to contain " + r(e)};
            var i = this.obj;
            if (n.isArray(i))if (n.isArray(e)) {
                var o = 0;
            ...
            } else this.assert(!1); else n.isString(i) ? this.assert(i.indexOf(String(e)) >= 0) : n.isObject(i) ? n.isObject(e) ? n.forOwn(e, function (e, r) {
    ...
    (function (t, n) {
        ...
        function h(t, e, r, n, i, o) {
            var s, a, c;
            if (c = Object.getOwnPropertyDescriptor(e, i) || {value: e[i]}, c.get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), S(n, i) || (s = "[" + i + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = g(r) ? u(t, c.value, null) : u(t, c.value, r - 1), a.indexOf("\n") > -1 && (a = o ? a.split("\n").map(function (t) {
                return"  " + t
            }).join("\n").substr(2) : "\n" + a.split("\n").map(function (t) {
                return"   " + t
        ...
        e.debuglog = function (t) {
            if (w(N) && (N = {NODE_ENV: "production"}.NODE_DEBUG || ""), t = t.toUpperCase(), !C[t])if (new RegExp("\\b" + t + "\\b", "i").test(N)) {
                var r = n.pid;
                C[t] = function () {
            ...
            return C[t]
        }, e.inspect = i, i.colors = {bold: [1, 22], italic: [3, 23], underline: [4, 24], inverse: [7, 27], white: [37, 39], grey: [90, 39], black: [30, 39], blue: [34, 39], cyan: [36, 39], green: [32, 39], magenta: [35, 39], red: [31, 39], yellow: [33, 39]}, i.styles = {special: "cyan", number: "yellow", "boolean": "yellow", undefined: "grey", "null": "bold", string: "green", date: "magenta", regexp: "red"}, e.isArray = d, e.isBoolean = y, e.isNull = g, e.isNullOrUndefined = v, e.isNumber = m, e.isString = _, e.isSymbol = b, e.isUndefined = w, e.isRegExp = j, e.isObject = E, e.isDate = x, e.isError = O, e.isFunction = A, e.isPrimitive = P, e.isBuffer = r(53);
    ...
    var o = {"./browser": 50, "./browser.js": 50, "./collection": 45, "./collection.js": 45, "./index": 27, "./index.js": 27, "./utils": 51, "./utils.js": 51};
    n.keys = function () {
        ...
        (function () {
            ...
            function a(t) {
                ...
                if ("boolean" == r || null == t)e[t] = !0; else {
                    "number" != r && "string" != r && (r = "object");
                    var n = "number" == r ? t : x + t, i = e[r] || (e[r] = {});
            ...
            function m(t) {
                ...
                function n(t) {
                    function e() {
                        ...
                        if (this instanceof e) {
                            var o = a(r.prototype), s = r.apply(o, t || arguments);
                            return Be(s) ? s : o
                        }
                ...
                function w(t) {
                    ...
                    var r = t[0], n = t[1], i = t[2], o = t[3], s = t[4], u = t[5], c = 1 & n, l = 2 & n, f = 4 & n, h = 8 & n, p = r;
                    return li(e, t), e
                }

                function A(t, e) {
                    var r = -1, n = ye(), i = t ? t.length : 0, a = i >= O && n === o, u = [];
                    if (a) {
                        var c = l(e);
                        c ? (n = s, e = c) : a = !1
                    }
                ...
                function se(t, e, r, n, i, o) {
                    ...
                    var a = typeof t, u = typeof e;
                    if (!(t !== t || t && ne[a] || e && ne[u]))return!1;
                    if (null == t || null == e)return t === e;
                    var c = Bn.call(t), l = Bn.call(e);
                    ...
                    var f = c == M;
                    if (!f) {
                        var p = Mn.call(t, "__wrapped__"), g = Mn.call(e, "__wrapped__");
                        if (p || g)return se(p ? t.__wrapped__ : t, g ? e.__wrapped__ : e, r, n, i, o);
                        if (c != G || !ui.nodeClass && (d(t) || d(e)))return!1;
                        var v = !ui.argsObject && _e(t) ? kn : t.constructor, m = !ui.argsObject && _e(e) ? kn : e.constructor;
                        if (v != m && !(Ue(v) && v instanceof v && Ue(m) && m instanceof m) && "constructor"in t && "constructor"in e)return!1
                    }
                    var _ = !i;
                    i || (i = h()), o || (o = h());
                    for (var b = i.length; b--;)if (i[b] == t)return o[b] == e;
                    var w = 0;
                    if (s = !0, i.push(t), o.push(e), f) {
                        if (b = t.length, w = e.length, s = w == b, s || n)for (; w--;) {
                            var j = b, E = e[w];
                            if (n)for (; j-- && !(s = se(t[j], E, r, n, i, o));); else if (!(s = se(t[w], E, r, n, i, o)))break
                        }
                ...
                function ae(t, e, r, n, i) {
                    (fi(e) ? nr : Oi)(e, function (e, o) {
                        var s, a, u = e, c = t[o];
                        if (e && ((a = fi(e)) || Ai(e))) {
                            for (var l = n.length; l--;)if (s = n[l] == e) {
                                c = i[l];
                                break
                            }
                            if (!s) {
                ...
                function le(t, e, r) {
                    var n = -1, i = ye(), a = t ? t.length : 0, u = [], c = !e && a >= O && i === o, f = r || c ? h() : u;
                    if (c) {
                        var p = l(f);
                        i = s, f = p
                    }
                    for (; ++n < a;) {
                        var d = t[n], v = r ? r(d, n, t) : d;
                ...
                function fe(t) {
                    return function (r, n, i) {
                        var o = {};
                        if (n = e.createCallback(n, i, 3), fi(r))for (var s = -1, a = r.length; ++s < a;) {
                            var u = r[s];
                            t(o, u, n(u, s, r), r)
                ...
                function he(t, e, r, i, o, s) {
                    var a = 1 & e, u = 2 & e, c = 4 & e, l = 16 & e, f = 32 & e;
                ...
                function qe(t) {
                    var e = arguments, r = 2;
                    if (!Be(t))return t;
                    if ("number" != typeof e[2] && (r = e.length), r > 3 && "function" == typeof e[r - 2])var n = b(e[--r - 1], e[r--], 2); else r > 2 && "function" == typeof e[r - 1] && (n = e[--r]);
                ...
                function Ke(t, r, n) {
                    var i = {};
                    if ("function" != typeof r)for (var o = -1, s = ie(arguments, !0, !1, 1), a = Be(t) ? s.length : 0; ++o < a;) {
                        var u = s[o];
                        u in t && (i[u] = t[u])
                    } else r = e.createCallback(r, n, 3), xi(t, function (t, e, n) {
                        r(t, e, n) && (i[e] = t)
                ...
                function Je(t, r, n, i) {
                    ...
                    if (null == n)if (o)n = []; else {
                        var s = t && t.constructor, u = s && s.prototype;
                        n = a(u)
                    }
                ...
                function Ze(t, e, r) {
                    var n = -1, i = ye(), o = t ? t.length : 0, s = !1;
                ...
                function Xe(t, r, n) {
                    var i = !0;
                    if (r = e.createCallback(r, n, 3), fi(t))for (var o = -1, s = t.length; ++o < s && (i = !!r(t[o], o, t));); else wi(t, function (t, e, n) {
                        return i = !!r(t, e, n)
                    });
                    return i
                }
                ...
                function tr(t, r, n) {
                    var i = [];
                    if (r = e.createCallback(r, n, 3), fi(t))for (var o = -1, s = t.length; ++o < s;) {
                        var a = t[o];
                        r(a, o, t) && i.push(a)
                ...
                function ir(t, e, r) {
                    ...
                    if (e = e && "undefined" == typeof r ? e : b(e, r, 3), fi(t))for (; i-- && e(t[i], i, t) !== !1;); else {
                        if ("number" != typeof i) {
                            var o = pi(t);
                            i = o.length
                ...
                function or(t, e) {
                    var r = v(arguments, 2), n = -1, i = "function" == typeof e, o = t ? t.length : 0, s = wn("number" == typeof o ? o : 0);
                ...
                function sr(t, r, n) {
                    var i = -1, o = t ? t.length : 0, s = wn("number" == typeof o ? o : 0);
                    if (r = e.createCallback(r, n, 3), fi(t))for (; ++i < o;)s[i] = r(t[i], i, t); else wi(t, function (t, e, n) {
                        s[++i] = r(t, e, n)
                    });
                    return s
                }
                ...
                function ar(t, r, n) {
                    var i = -1 / 0, o = i;
                    if ("function" != typeof r && n && n[r] === t && (r = null), null == r && fi(t))for (var s = -1, a = t.length; ++s < a;) {
                        var c = t[s];
                        c > o && (o = c)
                ...
                function gr(t, r, n) {
                    var i = -1, o = fi(r), s = t ? t.length : 0, a = wn("number" == typeof s ? s : 0);
                ...
                function Ar() {
                    ...
                    var f = t[0], p = -1, d = f ? f.length : 0, v = [];
                    t:for (; ++p < d;) {
                        var m = n[0];
                        if (c = f[p], (m ? s(m, c) : i(u, c)) < 0) {
                            for (e = r, (m || u).push(c); --e;)if (m = n[e], (m ? s(m, c) : i(t[e], c)) < 0)continue t;
                            v.push(c)
                        }
                    }
                    for (; r--;)m = n[r], m && g(m);
                ...
                function Tr(t) {
                    for (var e = arguments, r = 0, n = e.length, i = t ? t.length : 0; ++r < n;)for (var o = -1, s = e[r]; ++o < i;)t[o] === s && (Kn.call(t, o--, 1), i--);
                    return t
                }
                ...
                function Mr() {
                    for (var t = arguments, e = t.length; e--;)if (!Ue(t[e]))throw new Sn;
                    return function () {
                ...
                function Wr(t, e, r) {
                    ...
                    return function () {
                        if (n = arguments, s = Ri(), a = this, c = h && (u || !p), f === !1)var r = p && !u; else {
                            i || p || (l = s);
                            var g = f - (s - l), v = 0 >= g;
                ...
                function Jr(t, e) {
                    if (!Ue(t))throw new Sn;
                    var r = function () {
                        var n = r.cache, i = e ? e.apply(this, arguments) : x + arguments[0];
                ...
                function hn(t, r, n) {
                    ...
                    t = Fn(t || ""), n = Ei({}, n, i);
                    var o, s = Ei({}, n.imports, i.imports), a = pi(s), u = Ge(s), c = 0, l = n.interpolate || B, h = "__p += '", p = Tn((n.escape || B).source + "|" + l.source + "|" + (l === I ? R : B).source + "|" + (n.evaluate || B).source + "|$", "g");
                    t.replace(p, function (e, r, n, i, s, a) {
                        return n || (n = i), h += t.slice(c, a).replace(H, f), r && (h += "' +\n__e(" + r + ") +\n'"), s && (o = !0, h += "';\n" + s + ";\n__p += '"), n && (h += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"), c = a + e.length, e
                    }), h += "';\n";
                    var d = n.variable, y = d;
                ...
                var wn = t.Array, jn = t.Boolean, En = t.Date, xn = t.Error, On = t.Function, An = t.Math, Pn = t.Number, kn = t.Object, Tn = t.RegExp, Fn = t.String, Sn = t.TypeError, Rn = [], Nn = xn.prototype, Cn = kn.prototype, In = Fn.prototype, Un = t._, Bn = Cn.toString, Dn = Tn("^" + Fn(Bn).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"), Hn = An.ceil, Ln = t.clearTimeout, $n = An.floor, zn = On.prototype.toString, Vn = ge(Vn = kn.getPrototypeOf) && Vn, Mn = Cn.hasOwnProperty, qn = Rn.push, Wn = Cn.propertyIsEnumerable, Yn = t.setTimeout, Kn = Rn.splice, Jn = Rn.unshift, Gn = function () {
                    try {
                        var t = {}, e = ge(e = kn.defineProperty) && e, r = e(t, t, t) && e
                    } catch (n) {
                    }
                    return r
                }(), Qn = ge(Qn = kn.create) && Qn, Zn = ge(Zn = wn.isArray) && Zn, Xn = t.isFinite, ti = t.isNaN, ei = ge(ei = kn.keys) && ei, ri = An.max, ni = An.min, ii = t.parseInt, oi = An.random, si = {};
                si[M] = wn, si[q] = jn, si[W] = En, si[K] = On, si[G] = kn, si[J] = Pn, si[Q] = Tn, si[Z] = Fn;
                var ai = {};
                ai[M] = ai[W] = ai[J] = {constructor: !0, toLocaleString: !0, toString: !0, valueOf: !0}, ai[q] = ai[Z] = {constructor: !0, toString: !0, valueOf: !0}, ai[Y] = ai[K] = ai[Q] = {constructor: !0, toString: !0}, ai[G] = {constructor: !0}, function () {
                    for (var t = $.length; t--;) {
                        var e = $[t];
                ...
                !function () {
                    ...
                    try {
                        ui.nodeClass = !(Bn.call(document) == G && !({toString: 0} + ""))
                    } catch (o) {
                        ui.nodeClass = !0
                    }
                }(1), e.templateSettings = {escape: /<%-([\s\S]+?)%>/g, evaluate: /<%([\s\S]+?)%>/g, interpolate: I, variable: "", imports: {_: e}};
                var ci = function (t) {
                ...
                }, hi = pe({args: "object", init: "[]", top: "if (!(objectTypes[typeof object])) return result", loop: "result.push(index)"}), pi = ei ? function (t) {
                    return Be(t) ? ui.enumPrototypes && "function" == typeof t || ui.nonEnumArgs && t.length && _e(t) ? hi(t) : ei(t) : []
                } : hi, di = {args: "collection, callback, thisArg", top: "callback = callback && typeof thisArg == 'undefined' ? callback : baseCreateCallback(callback, thisArg, 3)", array: "typeof length == 'number'", keys: pi, loop: "if (callback(iterable[index], index, collection) === false) return result"}, yi = {args: "object, source, guard", top: "var args = arguments,\n    argsIndex = 0,\n    argsLength = typeof guard == 'number' ? 2 : args.length;\nwhile (++argsIndex < argsLength) {\n  iterable = args[argsIndex];\n  if (iterable && objectTypes[typeof iterable]) {", keys: pi, loop: "if (typeof result[index] == 'undefined') result[index] = iterable[index]", bottom: "  }\n}"}, gi = {top: "if (!objectTypes[typeof iterable]) return result;\n" + di.top, array: !1}, vi = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"}, mi = Te(vi), _i = Tn("(" + pi(mi).join("|") + ")", "g"), bi = Tn("[" + pi(vi).join("") + "]", "g"), wi = pe(di), ji = pe(yi, {top: yi.top.replace(";", ";\nif (argsLength > 3 && typeof args[argsLength - 2] == 'function') {\n  var callback = baseCreateCallback(args[--argsLength - 1], args[argsLength--], 2);\n} else if (argsLength > 2 && typeof args[argsLength - 1] == 'function') {\n  callback = args[--argsLength];\n}"), loop: "result[index] = callback ? callback(result[index], iterable[index]) : iterable[index]"}), Ei = pe(yi), xi = pe(di, gi, {useHas: !1}), Oi = pe(di, gi);
                Ue(/x/) && (Ue = function (t) {
                    return"function" == typeof t && Bn.call(t) == K
                });
                var Ai = Vn ? function (t) {
                    if (!t || Bn.call(t) != G || !ui.argsClass && _e(t))return!1;
                    var e = t.valueOf, r = ge(e) && (r = Vn(e)) && Vn(r);
                    return r ? t == r || Vn(t) == r : ve(t)
                } : ve, Pi = fe(function (t, e, r) {
                    Mn.call(t, r) ? t[r]++ : t[r] = 1
                }), ki = fe(function (t, e, r) {
                    (Mn.call(t, r) ? t[r] : t[r] = []).push(e)
                }), Ti = fe(function (t, e, r) {
                    t[r] = e
                }), Fi = sr, Si = tr, Ri = ge(Ri = En.now) && Ri || function () {
                ...
                return e.after = Lr, e.assign = ji, e.at = Qe, e.bind = $r, e.bindAll = zr, e.bindKey = Vr, e.chain = gn, e.compact = mr, e.compose = Mr, e.constant = en, e.countBy = Pi, e.create = je, e.createCallback = rn, e.curry = qr, e.debounce = Wr, e.defaults = Ei, e.defer = Yr, e.delay = Kr, e.difference = _r, e.filter = tr, e.flatten = Er, e.forEach = nr, e.forEachRight = ir, e.forIn = xi, e.forInRight = Oe, e.forOwn = Oi, e.forOwnRight = Ae, e.functions = Pe, e.groupBy = ki, e.indexBy = Ti, e.initial = Or, e.intersection = Ar, e.invert = Te, e.invoke = or, e.keys = pi, e.map = sr, e.mapValues = Me, e.max = ar, e.memoize = Jr, e.merge = qe, e.min = ur, e.omit = We, e.once = Gr, e.pairs = Ye, e.partial = Qr, e.partialRight = Zr, e.pick = Ke, e.pluck = Fi, e.property = cn, e.pull = Tr, e.range = Fr, e.reject = fr, e.remove = Sr, e.rest = Rr, e.shuffle = pr, e.sortBy = gr, e.tap = vn, e.throttle = Xr, e.times = pn, e.toArray = vr, e.transform = Je, e.union = Cr, e.uniq = Ir, e.values = Ge, e.where = Si, e.without = Ur, e.wrap = tn, e.xor = Br, e.zip = Dr, e.zipObject = Hr, e.collect = sr, e.drop = Rr, e.each = nr, e.eachRight = ir, e.extend = ji, e.methods = Pe, e.object = Hr, e.select = tr, e.tail = Rr, e.unique = Ir, e.unzip = Dr, sn(e), e.clone = be, e.cloneDeep = we, e.contains = Ze, e.escape = nn, e.every = Xe, e.find = er, e.findIndex = br, e.findKey = Ee, e.findLast = rr, e.findLastIndex = wr, e.findLastKey = xe, e.has = ke, e.identity = on, e.indexOf = xr, e.isArguments = _e, e.isArray = fi, e.isBoolean = Fe, e.isDate = Se, e.isElement = Re,e.isEmpty = Ne,e.isEqual = Ce,e.isFinite = Ie,e.isFunction = Ue,e.isNaN = De,e.isNull = He,e.isNumber = Le,e.isObject = Be,e.isPlainObject = Ai,e.isRegExp = $e,e.isString = ze,e.isUndefined = Ve,e.lastIndexOf = kr,e.mixin = sn,e.noConflict = an,e.noop = un,e.now = Ri,e.parseInt = Ni,e.random = ln,e.reduce = cr,e.reduceRight = lr,e.result = fn,e.runInContext = m,e.size = dr,e.some = yr,e.sortedIndex = Nr,e.template = hn,e.unescape = dn,e.uniqueId = yn,e.all = Xe,e.any = yr,e.detect = er,e.findWhere = er,e.foldl = cr,e.foldr = lr,e.include = Ze,e.inject = cr,sn(function () {
                    ...
                    e.prototype[n] || (e.prototype[n] = function (e, n) {
                        var o = this.__chain__, s = t(this.__wrapped__, e, n);
            ...
            var _, b = [], w = [], j = 0, E = {}, x = +new Date + "", O = 75, A = 40, P = " 	\f ﻿\n\r\u2028\u2029 ᠎             　", T = /\b__p \+= '';/g, F = /\b(__p \+=) '' \+/g, S = /(__e\(.*?\)|\b__t\)) \+\n'';/g, R = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, N = /\w*$/, C = /^\s*function[ \n\r\t]+\w/, I = /<%=([\s\S]+?)%>/g, U = RegExp("^[" + P + "]*0+(?=.$)"), B = /($^)/, D = /\bthis\b/, H = /['\n\r\t\u2028\u2029\\]/g, L = ["Array", "Boolean", "Date", "Error", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"], $ = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], z = 0, V = "[object Arguments]", M = "[object Array]", q = "[object Boolean]", W = "[object Date]", Y = "[object Error]", K = "[object Function]", J = "[object Number]", G = "[object Object]", Q = "[object RegExp]", Z = "[object String]", X = {};
            X[K] = !1, X[V] = X[M] = X[q] = X[W] = X[J] = X[G] = X[Q] = X[Z] = !0;
            var te = {leading: !1, maxWait: 0, trailing: !1}, ee = {configurable: !1, enumerable: !1, value: null, writable: !1}, re = {args: "", array: null, bottom: "", firstArg: "", init: "", keys: null, loop: "", shadowedProps: null, support: null, top: "", useHas: !1}, ne = {"boolean": !1, "function": !0, object: !0, number: !1, string: !1, undefined: !1}, ie = {"\\": "\\", "'": "'", "\n": "n", "\r": "r", "	": "t", "\u2028": "u2028", "\u2029": "u2029"}, oe = ne[typeof window] && window || this, se = ne[typeof e] && e && !e.nodeType && e, ae = ne[typeof t] && t && !t.nodeType && t, ue = (ae && ae.exports === se && se, ne[typeof i] && i);
    ...
    (function (e) {
        ...
        "undefined" != typeof Promise && (i = Promise), t.exports = function () {
            ...
            var o = r(55), s = r(56), a = r(57), u = function () {
            }, c = {}, l = {e: null}, f = r(58)(t, u), h = r(59)(t, u, f), p = r(60)(), d = r(61)(l), y = r(62), g = o.isArray, v = o.errorObj, m = o.tryCatch1, _ = o.tryCatch2, b = o.tryCatchApply, w = a.RangeError, j = a.TypeError, E = a.CancellationError, x = a.TimeoutError, O = a.OperationalError, A = a.originatesFromRejection, P = a.markAsOriginatingFromRejection, k = a.canAttach, T = o.thrower, F = r(63)(t), S = function () {
                return new j("circular promise resolution chain")
            };
            t.prototype.bind = function (e) {
                var r = f(e, void 0), n = new t(u);
                if (r instanceof t) {
                ...
                if (e === v)this._cleanValues(), this._setRejected(), this._settledValue = e.e, this._ensurePossibleRejectionHandled(); else {
                    var r = f(e, void 0);
                ...
                var i = g(r) ? b(e, r, n) : m(e, n, r), o = new t(u);
            ...
            var N = !1 || !("undefined" == typeof e || "string" != typeof e.execPath || !{NODE_ENV: "production"}.BLUEBIRD_DEBUG && "development" !== {NODE_ENV: "production"}.NODE_ENV);
            t.longStackTraces = function () {
                ...
                var o = this._length();
                if (o >= 262138 && (o = 0, this._setLength(0)), 0 === o)this._promise0 = n, void 0 !== i && (this._receiver0 = i), "function" != typeof t || this._isCarryingStackTrace() || (this._fulfillmentHandler0 = t), "function" == typeof e && (this._rejectionHandler0 = e), "function" == typeof r && (this._progressHandler0 = r); else {
                    var s = (o << 2) + o - 5;
                ...
                var r = this._length();
                if (r >= 262138 && (r = 0, this._setLength(0)), 0 === r)this._promise0 = e, this._receiver0 = t; else {
                    var n = (r << 2) + r - 5;
                ...
                if (this._popContext(), void 0 !== i && i === v) {
                    var o = i.e, s = k(o) ? o : new Error(o + "");
                    n._reject(o, s)
                }
            }, t.prototype._spreadSlowCase = function (t, e, r, n) {
                var i = new h(r).promise(), o = i._then(function () {
                    return t.apply(n, arguments)
                }, void 0, void 0, c, void 0);
                e._follow(o)
            }, t.prototype._callSpread = function (e, r, n) {
                var i = this._boundTo;
                if (g(n))for (var o = 0, s = n.length; s > o; ++o)if (f(n[o], void 0)instanceof t)return void this._spreadSlowCase(e, r, n, i);
                ...
                if (!i._isFollowing())if (o === v || o === i || o === l) {
                    var s = o === i ? S() : o.e, a = k(s) ? s : new Error(s + "");
                ...
                if (N) {
                    ...
                    var o = Error.stackTraceLimit || 10, s = (o + n) * i, a = r.length;
                ...
                var r = this.isFulfilled() ? this._fulfillmentHandlerAt(e) : this._rejectionHandlerAt(e), n = this._settledValue, i = this._receiverAt(e), o = this._promiseAt(e);
                if ("function" == typeof r)this._settlePromiseFromHandler(r, i, n, o); else {
                    var s = !1, a = this.isFulfilled();
                ...
                if (this._isRejectionUnhandled()) {
                    var t = this._settledValue, e = this._getCarriedStackTrace();
    ...
    function h(t, e, r, n, i, o) {
        var s, u, c;
        if (c = Object.getOwnPropertyDescriptor(e, i) || {value: e[i]}, c.get ? u = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (u = t.stylize("[Setter]", "special")), d(n, i) || (s = "[" + i + "]"), u || (t.seen.indexOf(c.value) < 0 ? (u = j(r) ? a(t, c.value, null) : a(t, c.value, r - 1), u.indexOf("\n") > -1 && (u = o ? u.split("\n").map(function (t) {
            return" " + t
        }).join("\n").substr(2) : "\n" + u.split("\n").map(function (t) {
            return" " + t
    ...
    var y = r(31), g = y.isBoolean, v = y.isObject, m = y.isUndefined, _ = y.isFunction, b = y.isString, w = y.isNumber, j = y.isNull, E = y.isRegExp, x = y.isDate, O = y.isError, A = y.isArray;
    e.inspect = n, n.colors = {bold: [1, 22], italic: [3, 23], underline: [4, 24], inverse: [7, 27], white: [37, 39], grey: [90, 39], black: [30, 39], blue: [34, 39], cyan: [36, 39], green: [32, 39], magenta: [35, 39], red: [31, 39], yellow: [33, 39]}, n.styles = {special: "cyan", number: "yellow", "boolean": "yellow", undefined: "grey", "null": "bold", string: "green", date: "magenta", regexp: "red"}, e._extend = function (t, e) {
        if (!e || !v(e))return t;
        for (var r = Object.keys(e), n = r.length; n--;)t[r[n]] = e[r[n]];
        return t
    }
    ...
    t.exports.merge = function (t, e) {
        ...
        for (var r = 1; e > r; r++)for (var n in arguments[r])t[n] = t[n] && "object" == typeof t[n] ? this.mergeRecursive(t[n], arguments[r][n]) : arguments[r][n];
        return t
    }
}, function (t, e, r) {
    function n(t, e) {
    ...
    function i(t, e) {
        ...
        try {
            var r, i, a = Object.keys(t), u = Object.keys(e)
        } catch (c) {
            return!1
        }
        if (a.length != u.length)return!1;
        for (a.sort(), u.sort(), i = a.length - 1; i >= 0; i--)if (a[i] != u[i])return!1;
        for (i = a.length - 1; i >= 0; i--)if (r = a[i], !n(t[r], e[r]))return!1;
        return!0
    }
    ...
    (function (t) {
        function t(e, r, n) {
            ...
            var i, o = typeof e;
            if ("number" === o)i = e > 0 ? e >>> 0 : 0; else if ("string" === o)"base64" === r && (e = j(e)), i = t.byteLength(e, r); else {
            ...
            var a;
            if (t.TYPED_ARRAY_SUPPORT && "number" == typeof e.byteLength)s._set(e); else if (x(e))if (t.isBuffer(e))for (a = 0; i > a; a++)s[a] = e.readUInt8(a); else for (a = 0; i > a; a++)s[a] = (e[a] % 256 + 256) % 256; else if ("string" === o)s.write(e, 0, r); else if ("number" === o && !t.TYPED_ARRAY_SUPPORT && !n)for (a = 0; i > a; a++)s[a] = 0;
            return s
        }
        ...
        t.TYPED_ARRAY_SUPPORT = function () {
            ...
            if (isFinite(e))isFinite(r) || (c = r, r = void 0); else {
                var l = c;
                c = e, e = r, r = l
            }
            e = Number(e) || 0;
            ...
            if (n || (n = 0), i || 0 === i || (i = this.length), r || (r = 0), i !== n && 0 !== e.length && 0 !== o.length) {
                ...
                var s = i - n;
                if (100 > s || !t.TYPED_ARRAY_SUPPORT)for (var a = 0; s > a; a++)e[a + r] = this[a + n]; else e._set(this.subarray(n, n + s), r)
            }
    ...
    var b = r(89), w = function () {
        try {
            var t = {};
            return b.defineProperty(t, "f", {get: function () {
                return 3
            }}), 3 === t.f
        } catch (e) {
            return!1
        }
    }(), j = "undefined" == typeof navigator, E = {e: {}}, x = function (t, e) {
        function r() {
    ...
    }(), P = /^[a-z$_][a-z$_0-9]*$/i, k = {isClass: g, isIdentifier: m, inheritedDataKeys: A, getDataPropertyOrDefault: p, thrower: y, isArray: b.isArray, haveGetters: w, notEnumerableProp: d, isPrimitive: c, isObject: l, canEvaluate: j, errorObj: E, tryCatch1: n, tryCatch2: i, tryCatch3: o, tryCatch4: s, tryCatchApply: a, inherits: x, withAppended: h, asString: u, maybeWrapAsError: f, wrapsPrimitiveReceiver: O, toFastProperties: v, filledRange: _};
    t.exports = k
}, function (t, e, r) {
    (function (e) {
        "use strict";
        ...
        var i = r(90), o = r(91), s = r(55).errorObj, a = r(55).tryCatch1, u = "undefined" != typeof e ? e : void 0;
    ...
    var c, l, f = r(89).freeze, h = r(55), p = h.inherits, d = h.notEnumerableProp, y = a("CancellationError", "cancellation error"), g = a("TimeoutError", "timeout error"), v = a("AggregateError", "aggregate error");
    try {
    ...
    var j = "__BluebirdErrorTypes__", E = Error[j];
    E || (E = f({CancellationError: y, TimeoutError: g, OperationalError: u, RejectionError: u, AggregateError: v}), d(Error, j, E)), t.exports = {Error: Error, TypeError: c, RangeError: l, CancellationError: E.CancellationError, OperationalError: E.OperationalError, TimeoutError: E.TimeoutError, AggregateError: E.AggregateError, originatesFromRejection: i, markAsOriginatingFromRejection: n, canAttach: s}
}, function (t, e, r) {
    "use strict";
    t.exports = function (t, e) {
        function n(t) {
        ...
        var a = r(55), u = r(57).canAttach, c = a.errorObj, l = a.isObject, f = {}.hasOwnProperty;
        return i
    }
}, function (t, e, r) {
    "use strict";
    t.exports = function (t, e, n) {
        ...
        function o(r) {
            var n = this._promise = new t(e), i = void 0;
        ...
        var s = r(57).canAttach, a = r(55), u = a.isArray;
        return o.prototype.length = function () {
            ...
            this._isResolved() || this._promise._progress({index: e, value: t})
    ...
    t.exports = function () {
        function t(t) {
            var r;
            if ("function" == typeof t)r = "[function " + (t.name || "anonymous") + "]"; else {
                r = t.toString();
        ...
        var i = r(55).inherits, o = r(89).defineProperty, s = new RegExp("\\b(?:[a-zA-Z0-9.]+\\$_\\w+|tryCatch(?:1|2|3|4|Apply)|new \\w*PromiseArray|\\w*PromiseArray\\.\\w*PromiseArray|setTimeout|CatchFilter\\$_\\w+|makeNodePromisified|processImmediate|process._tickCallback|nextTick|Async\\$\\w+)\\b"), a = null, u = null;
        ...
        var c = function l() {
            ...
            if ("string" == typeof r.stack && "function" == typeof"".startsWith && r.stack.startsWith("stackDetection@") && "stackDetection" === l.name) {
                o(Error, "stackTraceLimit", {writable: !0, enumerable: !1, configurable: !1, value: 25}), a = /@/;
                var n = /[@\n]/;
    ...
    t.exports = function (t) {
        ...
        var i = r(55), o = r(57), s = i.tryCatch1, a = i.errorObj, u = r(89).keys, c = o.TypeError;
        return e.prototype.doFilter = function (e) {
            for (var r = this._callback, i = this._promise, u = i._boundTo, c = 0, l = this._instances.length; l > c; ++c) {
                var f = this._instances[c], h = f === Error || null != f && f.prototype instanceof Error;
                if (h && e instanceof f) {
                    var p = s(r, u, e);
    ...
    var s, a = r(55), u = a.maybeWrapAsError, c = r(57), l = c.TimeoutError, f = c.OperationalError, h = r(56), p = a.haveGetters, d = r(89);
    if (s = p ? function (t) {
        this.promise = t
    } : function (t) {
    ...
    t.exports = function (t) {
        function e(e) {
            var r = new n(e), i = t.rejected(r), o = i._peekContext();
    ...
    t.exports = function (t, e, n) {
        ...
        function l(e) {
            var r = this.promise, i = this.handler, o = r._isBound() ? i.call(r._boundTo, e) : i(e);
            if (void 0 !== o) {
                var s = n(o, void 0);
        ...
        var f = r(55), h = f.wrapsPrimitiveReceiver, p = f.isPrimitive, d = f.thrower;
    ...
    "use strict";
    var n = r(55), i = n.isPrimitive, o = n.wrapsPrimitiveReceiver;
    t.exports = function (t) {
        var e = function () {
            return this
        }, r = function () {
    ...
    t.exports = function (t, e, n, i) {
        var o = r(55), s = o.canEvaluate, a = o.tryCatch1, u = o.errorObj;
        if (s) {
            ...
            d.prototype.callers = h, d.prototype.checkFulfillment = function (t) {
                ...
                var r = this.total;
                if (e >= r) {
                    var n = this.callers[r], i = a(n, void 0, this);
    ...
    "use strict";
    var n = function (t, e) {
        var r = arguments.length, n = arguments[2], i = arguments[3], o = r >= 5 ? arguments[4] : void 0;
        setTimeout(function () {
            t(n, i, o)
        }, 0 | e)
    };
    t.exports = function (t, e, i) {
        var o = (r(55), r(57)), s = (r(63)(t), t.TimeoutError), a = function (t, e, r) {
            if (t.isPending()) {
    ...
    t.exports = function (t, e, n) {
        ...
        var o = r(63)(t), s = r(55).isArray, a = function (t) {
    ...
    t.exports = function (t) {
        ...
        var h = r(55), p = h.canEvaluate, d = h.isIdentifier;
    ...
    t.exports = function (t, e, n, i) {
        ...
        var a = r(57), u = a.TypeError, c = r(55).deprecated, l = r(55), f = l.errorObj, h = l.tryCatch1, p = [];
        s.prototype.promise = function () {
            ...
            var n = e.value;
            if (e.done === !0)this._generator = void 0, this._promise._tryFollow(n) || this._promise._fulfill(n); else {
                var s = i(n, void 0);
            ...
            var r = Object(e).yieldHandler, n = s;
            return function () {
                var e = t.apply(this, arguments), i = new n(void 0, void 0, r);
            ...
            var n = new s(r, this), i = n.promise();
    ...
    t.exports = function (t, e, n, i, o) {
        ...
        var u = r(55), c = u.tryCatch3, l = u.errorObj, f = {}, h = [];
        u.inherits(s, e), s.prototype._init = function () {
        }, s.prototype._promiseFulfilled = function (e, r) {
            var n = this._values;
            if (null !== n) {
                var o = this.length(), s = this._preservedValues, a = this._limit;
                if (n[r] === f) {
                    ...
                    null !== s && (s[r] = e);
                    var u = this._callback, h = this._promise._boundTo, p = c(u, h, e, r, o);
    ...
    t.exports = function (t) {
        ...
        function i(t, r) {
            var n = this, i = void 0 === t ? c(n, r, null) : u(n, r, null, t);
            i === l && a.invokeLater(e, void 0, i.e)
        }

        function o(t, r) {
            var n = this, i = c(n, r, t);
            i === l && a.invokeLater(e, void 0, i.e)
        }

        var s = r(55), a = r(56), u = s.tryCatch2, c = s.tryCatch1, l = s.errorObj;
    ...
    t.exports = function (t, e) {
        ...
        function s(t, e, r) {
            for (var n = 0; n < t.length; n += 2) {
                var i = t[n];
                if (r.test(i))for (var o = i.replace(r, ""), s = 0; s < t.length; s += 2)if (t[s] === o)throw new E("Cannot promisify an API that has normal methods with '" + e + "'-suffix")
            }
        }
        ...
        function p(r, n, i, o, s) {
            ...
            var d = Math.max(0, f(o) - 1), y = u(d), g = "string" == typeof i && m.isIdentifier(i) ? i + s : "promisified";
        ...
        var v = {}, m = r(55), _ = r(62)._nodebackForPromise, b = m.withAppended, w = m.maybeWrapAsError, j = m.canEvaluate, E = r(57).TypeError, x = "Async", O = function (t, e) {
            return m.isIdentifier(t) && "_" !== t.charAt(0) && !m.isClass(e)
        }, A = {__isPromisified__: !0}, P = j ? p : d;
        t.promisify = function (t, e) {
            ...
            for (var o = m.inheritedDataKeys(t, {includeHidden: !0}), s = 0; s < o.length; ++s) {
                var a = t[o[s]];
    ...
    t.exports = function (t, e, n) {
        ...
        var s = r(55), a = r(63)(t), u = s.isObject, c = r(89);
        s.inherits(i, e), i.prototype._init = function () {
            ...
            this._isResolved() || this._promise._progress({key: this._values[e + this.length()], value: t})
    ...
    t.exports = function (t, e, n, i, o) {
        function s(e, r, n, s) {
            ...
            var a = i(n, void 0), u = !1, c = a instanceof t;
        ...
        var u = r(55), c = u.tryCatch4, l = u.tryCatch3, f = u.errorObj;
        u.inherits(s, e), s.prototype._init = function () {
            ...
            var n = this._values;
            if (null !== n) {
                var o, s = this.length(), a = this._preservedValues, u = null !== a, h = this._gotAccum, p = this._valuesPhase;
                if (!p)for (p = this._valuesPhase = Array(s), o = 0; s > o; ++o)p[o] = 0;
                if (o = p[r], 0 === r && this._zerothIsAccum ? (h || (this._accum = e, this._gotAccum = h = !0), p[r] = 0 === o ? 1 : 2) : -1 === r ? h || (this._accum = e, this._gotAccum = h = !0) : 0 === o ? p[r] = 1 : (p[r] = 2, h && (this._accum = e)), h) {
                    for (var d, y = this._callback, g = this._promise._boundTo, v = this._reducingIndex; s > v; ++v)if (o = p[v], 2 !== o) {
                        if (1 !== o)return;
    ...
    t.exports = function (t, e) {
        ...
        var i = t.PromiseInspection, o = r(55);
    ...
    t.exports = function (t, e, n) {
        ...
        var s = r(55), a = r(57).RangeError, u = r(57).AggregateError, c = s.isArray;
        s.inherits(i, e), i.prototype._init = function () {
    ...
    "use strict";
    t.exports = function (t, e) {
        var n = r(55), i = r(56), o = r(57), s = n.tryCatch1, a = n.errorObj;
        t.prototype.progressed = function (t) {
            ...
            var r = e.value, n = e.handler, i = e.promise, u = e.receiver, c = s(n, u, r);
            if (c === a) {
            ...
            if (this.isPending())for (var n = this._length(), o = this._progress, s = 0; n > s; s++) {
                var a = this._progressHandlerAt(s), u = this._promiseAt(s);
                if (u instanceof t)"function" == typeof a ? i.invoke(this._doProgressWith, this, {handler: a, promise: u, receiver: this._receiverAt(s), value: r}) : i.invoke(o, u, r); else {
    ...
    "use strict";
    t.exports = function (t, e) {
        var n = r(57), i = n.canAttach, o = r(56), s = n.CancellationError;
    ...
    t.exports = function (t, e, n) {
        ...
        var h = r(57).TypeError, p = r(55).inherits, d = t.PromiseInspection;
        l.prototype.data = function () {
            ...
            var e = this.resource(), r = null !== e ? this.doDispose(e, t) : null;
    ...
    if (e)t.exports = {freeze: Object.freeze, defineProperty: Object.defineProperty, keys: Object.keys, getPrototypeOf: Object.getPrototypeOf, isArray: Array.isArray, isES5: e}; else {
        var r = {}.hasOwnProperty, n = {}.toString, i = {}.constructor.prototype, o = function (t) {
            var e = [];
        ...
        t.exports = {isArray: c, keys: o, defineProperty: s, freeze: a, getPrototypeOf: u, isES5: e}
    }
}, function (t, e, r) {
    (function (e) {
        "use strict";
        ...
        if ("object" == typeof e && "string" == typeof e.version)r = function (t) {
            ...
            var t = document.createElement("div"), e = void 0, r = new n(function () {
                var t = e;
                e = void 0, t()
            });
            return r.observe(t, {attributes: !0}), function (r) {
    ...
    r.prototype._willBeOverCapacity = function (t) {
        ...
        var r = this._front, n = this._capacity, i = new Array(n), o = this.length();
        if (e(this, 0, i, 0, n), this._capacity = t, this._makeCapacity(), this._front = 0, n >= r + o)e(i, r, this, 0, o); else {
            var s = o - (r + o & n - 1);
    ...
    e.read = function (t, e, r, n, i) {
        ...
        var s, a, u, c = 8 * o - i - 1, l = (1 << c) - 1, f = l >> 1, h = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : o - 1, d = n ? 1 : -1, y = 0 > e || 0 === e && 0 > 1 / e ? 1 : 0;
    ...
    !function (t) {
        ...
        var o = "undefined" != typeof Uint8Array ? Uint8Array : Array, s = "+".charCodeAt(0), a = "/".charCodeAt(0), u = "0".charCodeAt(0), c = "a".charCodeAt(0), l = "A".charCodeAt(0);
