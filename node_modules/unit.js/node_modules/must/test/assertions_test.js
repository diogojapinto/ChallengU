...
function assertFail(fn) {
    assert.throws(fn, Must.AssertionError)
}
function assertPass(fn) {
...
function mustPassThroughToEqual(name) {
    ...
    it("must be like Must.prototype.equal", function () {
        assertPass(function () {
            false.must[name](false)
        })
        assertFail(function () {
            true.must[name](false)
        })
...
function mustPassBoolean(name, truthy) {
    ...
    it("must " + fail + " given false object", function () {
        throws(function () {
            Must(new Boolean(false)).be[name]()
        })
    })
...
describe("Must.prototype.undefined", function () {
    it("must pass given undefined", function () {
        assertPass(function () {
            Must(undefined).be.undefined()
        })
    })

    it("must fail given true literal", function () {
        assertFail(function () {
            Must(true).be.undefined()
        })
    })

    it("must fail given false literal", function () {
        assertFail(function () {
            Must(false).be.undefined()
        })
    })

    it("must fail given null", function () {
        assertFail(function () {
            Must(null).be.undefined()
        })
    })
    ...
    describe(".not", function () {
        function not() {
            Must(undefined).not.be.undefined()
        }
...
describe("Must.prototype.function", function () {
    var dump = "function () {}"
    mustPassType("function", "be a function", {object: function () {
    }}, dump)
...
function mustPassTruthy(name, truthy) {
    ...
    describe("given String", function () {
        ...
        it("must " + pass + " given object", function () {
            doesNotThrow(function () {
                Must(new String("truthy")).be[name]()
            })
        })
...
describe("Must.prototype.instanceof", function () {
    describe("given Boolean", function () {
        it("must fail given boolean literal", function () {
            ...
            assertFail(function () {
                false.must.be.instanceof(Boolean)
            })
        })
        ...
        it("must fail given Boolean constructor", function () {
            assertFail(function () {
                Boolean.must.be.instanceof(Boolean)
            })
        })
    })
    ...
    describe("given Number", function () {
        ...
        it("must fail given Number constructor", function () {
            assertFail(function () {
                Number.must.be.instanceof(Number)
            })
        })
    })
    ...
    describe("given String", function () {
        ...
        it("must fail given String constructor", function () {
            assertFail(function () {
                String.must.be.instanceof(String)
            })
        })
    })
    ...
    describe("given Array", function () {
        it("must pass given array", function () {
            assertPass(function () {
                [].must.be.instanceof(Array)
            })
        })

        it("must fail given Array constructor", function () {
            assertFail(function () {
                Array.must.be.instanceof(Array)
            })
        })
    })
    ...
    describe("given Function", function () {
        ...
        it("must pass given Function constructor", function () {
            assertPass(function () {
                Function.must.be.instanceof(Function)
            })
        })
    })
...
describe("Must.prototype.equal", function () {
    ...
    describe("given Boolean", function () {
        function mustPassTrueEqual(bool) {
            it("must pass given " + bool + " literals", function () {
                assertPass(function () {
                    Must(bool).be.equal(bool)
                })
            })

            it("must fail given " + bool + " literal and object", function () {
                assertFail(function () {
                    Must(bool).be.equal(new Boolean(bool))
                })
                assertFail(function () {
                    Must(new Boolean(bool)).be.equal(bool)
                })
            })
    ...
    describe("given Number", function () {
        ...
        it("must fail given unequivalent literals", function () {
            assertFail(function () {
                Must(42).be.equal(1337)
            })
        })

        it("must fail given equivalent literal and object", function () {
            assertFail(function () {
                Must(42).be.equal(new Number(42))
            })
            assertFail(function () {
                Must(new Number(42)).be.equal(42)
            })
        })
    ...
    describe("given String", function () {
        ...
        it("must fail given unequivalent literals", function () {
            assertFail(function () {
                Must("ok").be.equal("nok")
            })
        })

        it("must fail given equivalent literal and object", function () {
            assertFail(function () {
                Must("ok").be.equal(new String("ok"))
            })
            assertFail(function () {
                Must(new String("ok")).be.equal("ok")
            })
        })
    ...
    describe("given RegExp", function () {
        ...
        it("must pass given identical regexps", function () {
            ...
            assertPass(function () {
                Must(regexp).be.equal(regexp)
            })
        })

        it("must fail given equivalent regexps", function () {
            assertFail(function () {
                Must(new RegExp).be.equal(new RegExp)
            })
        })
    })
    ...
    describe("given Date", function () {
        it("must pass given identical dates", function () {
            var now = new Date
            assertPass(function () {
                Must(now).be.equal(now)
            })
        })

        it("must fail given equivalent dates", function () {
            assertFail(function () {
                Must(new Date(42)).be.equal(new Date(42))
            })
        })
    })
    ...
    describe("given Array", function () {
        ...
        it("must pass given identical arrays", function () {
            var array = new Array
            assertPass(function () {
                Must(array).be.equal(array)
            })
        })

        it("must fail given unidentical arrays", function () {
            assertFail(function () {
                Must(new Array).be.equal(new Array)
            })
        })
    })
...
describe("Must.prototype.eql", function () {
    it("must pass given nulls", function () {
        assertPass(function () {
            Must(null).be.eql(null)
        })
    })

    it("must pass given undefineds", function () {
        assertPass(function () {
            Must(undefined).be.eql(undefined)
        })
    })

    it("must fail given null and undefined", function () {
        assertFail(function () {
            Must(null).be.eql(undefined)
        })
        assertFail(function () {
            Must(undefined).be.eql(null)
        })
    })
    ...
    describe("given Boolean", function () {
        function mustPassBooleanEql(bool) {
            it("must pass given " + bool + " literals", function () {
                assertPass(function () {
                    Must(bool).be.eql(bool)
                })
            })

            it("must pass given " + bool + " literal and object", function () {
                assertPass(function () {
                    Must(bool).be.eql(new Boolean(bool))
                })
                assertPass(function () {
                    Must(new Boolean(bool)).be.eql(bool)
                })
            })
    ...
    describe("given Number", function () {
        ...
        it("must pass given equivalent literal and object", function () {
            assertPass(function () {
                Must(42).be.eql(new Number(42))
            })
            assertPass(function () {
                Must(new Number(42)).be.eql(42)
            })
        })

        it("must pass given equivalent objects", function () {
            assertPass(function () {
                Must(new Number(42)).be.eql(new Number(42))
            })
        })
        ...
        it("must fail given unequivalent objects", function () {
            assertFail(function () {
                Must(new Number(42)).be.eql(new Number(69))
            })
        })
    ...
    describe("given String", function () {
        ...
        it("must pass given equivalent literal and object", function () {
            assertPass(function () {
                Must("ok").be.eql(new String("ok"))
            })
            assertPass(function () {
                Must(new String("ok")).be.eql("ok")
            })
        })

        it("must pass given equivalent objects", function () {
            assertPass(function () {
                Must(new String("ok")).be.eql(new String("ok"))
            })
        })
        ...
        it("must fail given unequivalent objects", function () {
            assertFail(function () {
                Must(new String("ok")).be.eql(new String("no"))
            })
        })
    ...
    describe("given Date", function () {
        ...
        it("must pass given equivalent dates", function () {
            assertPass(function () {
                Must(new Date(7)).be.eql(new Date(7))
            })
        })

        it("must fail given unequivalent dates", function () {
            assertFail(function () {
                Must(new Date(69)).be.eql(new Date(42))
            })
        })
    })
    ...
    function mustPassObjectEql(create) {
        ...
        it("must pass given empty objects", function () {
            assertPass(function () {
                Must(create({})).be.eql(create({}))
            })
        })

        it("must fail given an empty and filled object", function () {
            assertFail(function () {
                Must({}).be.eql(create({a: 42}))
            })
            assertFail(function () {
                Must(create({a: 42})).be.eql(create({}))
            })
        })
    ...
    describe("given instance", function () {
        ...
        it("must fail given different constructors", function () {
            assertFail(function () {
                Must(new new Function).eql(new new Function)
            })
        })
        ...
        describe("given valueOf", function () {
            it("must pass given identical output", function () {
                ...
                Valuable.prototype.valueOf = function () {
                    return this.value
                }
            ...
            it("must fail given identical output from heir", function () {
                ...
                assertFail(function () {
                    Must(new Parent(42)).eql(new Child(42))
                })
            })
        })
    })
...
describe("Must.prototype.empty", function () {
    describe("given Boolean", function () {
        ...
        it("must pass given a true object", function () {
            assertPass(function () {
                Must(new Boolean(true)).be.empty()
            })
        })

        it("must pass given a false object", function () {
            assertPass(function () {
                Must(new Boolean(false)).be.empty()
            })
        })
    ...
    describe("given Number", function () {
        ...
        it("must pass given a zero object", function () {
            assertPass(function () {
                Must(new Number).be.empty()
            })
        })

        it("must pass given a non-zero object", function () {
            assertPass(function () {
                Must(new Number(1)).be.empty()
            })
        })
    ...
    describe("given String", function () {
        ...
        it("must pass given an empty object", function () {
            assertPass(function () {
                Must(new String).be.empty()
            })
        })

        it("must fail given a non-empty object", function () {
            assertFail(function () {
                Must(new String("a")).be.empty()
            })
        })
    })
    ...
    describe("given RegExp", function () {
        it("must pass given an empty object", function () {
            assertPass(function () {
                Must(new RegExp).be.empty()
            })
        })

        it("must pass given a non-empty object", function () {
            assertPass(function () {
                Must(new RegExp("a")).be.empty()
            })
        })
    ...
    describe("given Function", function () {
        it("should pass given an empty object", function () {
            assertPass(function () {
                Must(new Function).be.empty()
            })
        })

        it("should pass given a non-empty object", function () {
            assertPass(function () {
                Must(new Function("a")).be.empty()
            })
        })
    ...
    describe("given Object", function () {
        ...
        it("must fail given a non-empty object", function () {
            assertFail(function () {
                Must({life: 42}).be.empty()
            })
        })

        it("must fail given a non-empty inherited object", function () {
            assertFail(function () {
                Must(Object.create({life: 42})).be.empty()
            })
        })
    })
...
describe("Must.prototype.include", function () {
    describe("given String", function () {
        ...
        it("must fail if given string object does not include string object",
            function () {
                assertFail(function () {
                    Must(object).include(new String("good"))
                })
            })
    })
    ...
    describe("given Object", function () {
        it("must pass if given object includes number literal", function () {
            assertPass(function () {
                ({a: 1, b: 2, c: 3}).must.include(2)
            })
        })

        it("must fail if given array does not include number literal", function () {
            assertFail(function () {
                ({a: 1, b: 2, c: 3}).must.include(42)
            })
        })
...
describe("Must.prototype.permutationOf", function () {
    ...
    describe(".not", function () {
        function not() {
            [1, 2, 3].must.not.be.a.permutationOf([1, 2, 3])
        }
...
describe("Must.prototype.throw", function () {
    ...
    describe("given String", function () {
        ...
        it("must fail if function throws an unequivalent string", function () {
            assertFail(function () {
                stringThrower.must.throw("Oh yes!")
            })
        })
    ...
    describe("given Function", function () {
        ...
        describe("with String", function () {
            ...
            it("must pass if function throws with identical message", function () {
                assertPass(function () {
                    thrower.must.throw(TypeError, "Oh no!")
                })
            })

            it("must fail if function throws other instance", function () {
                assertFail(function () {
                    thrower.must.throw(RangeError, "Oh no!")
                })
            })
            ...
            it("must fail if function throws with unequivalent message", function () {
                assertFail(function () {
                    thrower.must.throw(TypeError, "Oh yes!")
                })
            })
        })
        ...
        describe("with RegExp", function () {
            ...
            it("must pass if function throws with matching message", function () {
                assertPass(function () {
                    thrower.must.throw(TypeError, /no!/)
                })
            })

            it("must fail if function throws other instsance", function () {
                assertFail(function () {
                    thrower.must.throw(RangeError, /no!/)
                })
            })

            it("must fail if function throws with unmatching message", function () {
                assertFail(function () {
                    thrower.must.throw(TypeError, /yes!/)
                })
            })
        })
    })
    ...
    var noThrower = function () {
        42
    }
    mustThrowAssertionError(function () {
        noThrower.must.throw()
    }, {
        actual : noThrower,
...
describe("Must.prototype.length", function () {
    ...
    describe("given Array", function () {
        it("must pass if length equal", function () {
            assertPass(function () {
                [1, 2, 3, 4].must.have.length(4)
            })
        })

        it("must fail if length not equal", function () {
            assertFail(function () {
                [1, 2, 3, 4].must.have.length(42)
            })
        })
    })
...
function mustPassProperty(name, inheritable) {
    ...
    var errName = name.replace(/[A-Z]/, function (l) {
    ...
    describe("given name", function () {
        ...
        describe(".not", function () {
            function not() {
                ({love: 69}).must.not.have[name]("love")
            }
    ...
    describe("given name and value", function () {
        ...
        it("must " + pass + " if object has inherited property with identical value",
            function () {
                var obj = Object.create({love: 69})
                doesNotThrow(function () {
                    obj.must.have[name]("love", 69)
                })
            })

        it("must fail if object doesn't have property", function () {
            assertFail(function () {
                ({}).must.have[name]("love", 69)
            })
        })
        ...
        it("must " + pass + " if object has inherited property asserted undefined",
            function () {
                var obj = Object.create({love: undefined})
                doesNotThrow(function () {
                    obj.must.have[name]("love", undefined)
                })
            })
        ...
        describe(".not", function () {
            function not() {
                ({love: 69}).must.not.have[name]("love", 69)
            }
    ...
    it("must " + pass + " if String.prototype has property", function () {
        ...
        doesNotThrow(function () {
            "Hello".must.have[name]("life")
        })
    })

    afterEach(function () {
        delete Boolean.prototype.life
    })
    ...
    it("must " + pass + " if false's Boolean.prototype has property", function () {
        ...
        doesNotThrow(function () {
            false.must.have[name]("life")
        })
    })

    it("must fail gracefully if null", function () {
        assertFail(function () {
            Must(null).have[name]("love")
        })
    })

    it("must fail gracefully if undefined", function () {
        assertFail(function () {
            Must(undefined).have[name]("love")
        })
    })
}
...
function mustPassKeys(name, inheritable) {
    ...
    it("must fail given a different amount of keys", function () {
        assertFail(function () {
            Must({a: 1}).have[name](["a", "b"])
        })
        assertFail(function () {
            Must({a: 1, b: 2}).have[name](["a"])
        })
    })
...
describe("Must.prototype.keys", function () {
    ...
    describe(".not", function () {
        function not() {
            ({a: 1, b: 2}).must.not.have.keys(["a", "b"])
        }
...
describe("Must.prototype.ownKeys", function () {
    ...
    describe(".not", function () {
        function not() {
            ({a: 1, b: 2}).must.not.have.ownKeys(["a", "b"])
        }
...
function mustPassEnumerable(name, truthy) {
    ...
    describe(".not", function () {
        ...
        function not() {
            errObj.must.not.have[name](errProp)
        }
...
describe(".prototype.frozen", function () {
    ...
    describe(".not", function () {
        function not() {
            Object.freeze({}).must.not.be.frozen()
        }
...
describe(".prototype.most", function () {
    ...
    it("must pass if equal", function () {
        assertPass(function () {
            (69).must.be.at.most(69)
        })
    })

    it("must fail if above", function () {
        assertFail(function () {
            (1337).must.be.at.most(69)
        })
    })

    mustThrowAssertionError(function () {
        (69).must.be.at.most(42)
    }, {
        actual  : 69,
        expected: 42,
...
describe(".prototype.least", function () {
    ...
    it("must pass if equal", function () {
        assertPass(function () {
            (69).must.be.at.least(69)
        })
    })

    it("must fail if below", function () {
        assertFail(function () {
            (69).must.be.at.least(1337)
        })
    })

    mustThrowAssertionError(function () {
        (42).must.be.at.least(69)
    }, {
        actual  : 42,
        expected: 69,
...
describe("Must.prototype.between", function () {
    it("must fail if below", function () {
        assertFail(function () {
            (41).must.be.between(42, 69)
        })
    })

    it("must pass if on lower bound", function () {
        assertPass(function () {
            (42).must.be.between(42, 69)
        })
    })

    it("must pass if between", function () {
        assertPass(function () {
            (50).must.be.between(42, 69)
        })
    })

    it("must pass if on higher bound", function () {
        assertPass(function () {
            (69).must.be.between(42, 69)
        })
    })

    it("must fail if above", function () {
        assertFail(function () {
            (70).must.be.between(42, 69)
        })
    })

    mustThrowAssertionError(function () {
        (13).must.be.between(42, 69)
    }, {
        actual : 13,
